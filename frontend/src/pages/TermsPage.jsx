...
const TermsPage = ({ onBack }) => {
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto', background: 'var(--panel-bg)', borderRadius: '16px', border: '1px solid rgba(157, 0, 255, 0.4)', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.8)' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
        <h2 className="neon-text-purple" style={{ margin: 0 }}>Términos y Condiciones</h2>
        <button className="btn-neon" style={{ padding: '5px 15px', margin: 0, fontSize: '0.9rem' }} onClick={onBack}>
          Volver
        </button>
      </div>

      <div style={{ color: 'var(--text-primary)', lineHeight: '1.6', fontSize: '0.95rem' }}>
        <p>Bienvenido a <strong>Talking Crow</strong>. Al utilizar nuestra plataforma para el envío de donaciones mediante síntesis de voz impulsada por Inteligencia Artificial, aceptas los siguientes términos de servicio. Nuestro objetivo es crear una comunidad divertida, segura y libre de abusos.</p>
        ...
        <ul style={{ paddingLeft: '20px', marginBottom: '20px' }}>
          ...
          <li style={{ marginBottom: '10px' }}>Cedes a Talking Crow el derecho temporal de procesar tu voz con el único fin de generar la síntesis para el mensaje de tu donación.</li>
        ...
        <p>Todo mensaje enviado a través de Talking Crow está sujeto a moderación humana antes de ser emitido en el Stream.</p>
        ...
        <ul style={{ paddingLeft: '20px', marginBottom: '20px' }}>
          <li style={{ marginBottom: '10px' }}>El Creador de Contenido no se hace responsable de las opiniones expresadas a través de la IA de Talking Crow, ya que el contenido es originado por terceros (donadores).</li>
          ...
          <li style={{ marginBottom: '10px' }}>Al aceptar estos términos, liberas a Talking Crow y a sus operadores de cualquier responsabilidad legal derivada del mal uso que puedas darle a la plataforma.</li>
        </ul>
