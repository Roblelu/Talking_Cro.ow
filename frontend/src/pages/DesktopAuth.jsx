...
export default function DesktopAuth({ onNavigate }) {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%', flexDirection: 'column' }}>
      <img src="https://talking-crow.web.app/assets/hevel-logo.png" alt="Logo" style={{ width: '100px', marginBottom: '20px', animation: 'pulse 2s infinite' }} onError={(e) => e.target.style.display = 'none'} />
